...
.. seealso::
  ...
  For functions that work out of combat, see :doc:`Change Monster </Doc/Functions/General/ChangeMonster>`.
...
If you want to display the damage number from the skill, use [DamageToEnemy] in the following :term:`string` after calling the function.
